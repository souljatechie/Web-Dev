...
<?php } ?>
	...
	<p>
		<img src="<?php echo $thumb['../../../../../testing/wordpress/wp-admin/includes/url']; ?>" width="<?php echo $thumb_img[0]; ?>" height="<?php echo $thumb_img[1]; ?>" class="imgedit-size-preview" alt="" /><br /><?php _e('Current thumbnail'); ?>
	</p>
