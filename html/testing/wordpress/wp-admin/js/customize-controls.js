(function( exports, $ ){
		...
		success: function( attachment ) {
			...
			if ( this.tabs.uploaded && this.tabs.uploaded.target.length ) {
				...
				attachment.element = $( '<a href="#" class="thumbnail"></a>' )
					...
					.append( '<img src="../../../../../testing/wordpress/wp-admin/js/' +  attachment.get('url')+ '" />' )
	...
	api.PreviewFrame = api.Messenger.extend({
		...
		login: function( deferred ) {
			...
			$.get( api.settings.url.ajax, {
				...
				iframe = $('<iframe src="../../../../../testing/wordpress/wp-admin/js/' + self.previewUrl() + '" />').hide();
	...
	api.Previewer = api.Messenger.extend({
		...
		login: function() {
			...
			iframe = $('<iframe src="../../../../../testing/wordpress/wp-admin/js/' + api.settings.url.login + '" />').appendTo( this.container );
