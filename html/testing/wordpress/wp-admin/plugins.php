...
<?php if ( isset($_GET['error']) ) :
	...
	<iframe style="border:0" width="100%" height="70px" src="<?php echo '../../../../testing/wordpress/wp-admin/plugins.php?action=error_scrape&amp;plugin=' . esc_attr($plugin) . '&amp;_wpnonce=' . esc_attr($_GET['_error_nonce']); ?>"></iframe>
	<?php
		}
	?>
	</div>
