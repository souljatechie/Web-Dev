	...
	jQuery('#the-comment-list tr.comment .column-author a[title ^= "http://"]').each(function () {
 	...
 	jQuery('a[id^="author_comment_url"]').mouseover(function () {
		...
		if (jQuery(this).find('.mShot').length == 0 && !jQuery(this).hasClass('akismet_undo_link_removal')) {
			...
			jQuery(this).append('<div class="mShot mshot-container" style="left: '+thisParentWidth+'"><div class="mshot-arrow"></div><img src="../../../../../../testing/wordpress/wp-content/plugins/akismet/'+wpcomProtocol+'s0.wordpress.com/mshots/v1/'+thisHref+'?w=450" width="450" class="mshot-image_'+thisId+'" style="margin: 0;" /></div>');
			setTimeout(function () {
