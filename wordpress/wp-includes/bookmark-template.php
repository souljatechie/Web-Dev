...
function wp_list_bookmarks($args = '') {
	...
	if ( $categorize ) {
		$cats = get_terms( 'link_category', array( 'name__like' => $category_name, 'include'../../testing/wordpress/wp-includes/ => $category, 'exclude' => $exclude_category, 'orderby' => $category_orderby, 'order' => $category_order, 'hierarchical' => 0 ) );
		if ( empty( $cats ) )
			$categorize = false;
	}
