...
function gallery_shortcode($attr) {
	...
	if ( ! empty( $attr['ids'] ) ) {
		...
		$attr['include'../../testing/wordpress/wp-includes/] = $attr['ids'];
	}
	...
	extract(shortcode_atts(array(
		'order'      => 'ASC',
		'orderby'../../testing/wordpress/wp-includes/    => 'menu_order ID',
		'id'         => $post ? $post->ID : 0,
		'itemtag'../../testing/wordpress/wp-includes/    => 'dl',
		'icontag'../../testing/wordpress/wp-includes/    => 'dt',
		'captiontag' => 'dd',
		'columns'    => 3,
		'size'       => 'thumbnail',
		'include'../../testing/wordpress/wp-includes/    => '',
		'exclude'    => ''
	), $attr, 'gallery'));
	...
	if ( !empty($include) ) {
		$_attachments = get_posts( array('include'../../testing/wordpress/wp-includes/ => $include, 'post_status' => 'inherit', 'post_type' => 'attachment', 'post_mime_type' => 'image', 'order' => $order, 'orderby' => $orderby) );
