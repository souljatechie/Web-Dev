				...
				switch ($trackarray['TrackType']) {
					...
					case 2: // Audio
						...
						switch ($trackarray['CodecID']) {
							...
							case 'A_MPEG/L2':
							case 'A_FLAC':
								if (!getid3_lib::IncludeDependency(GETID3_INCLUDEPATH.'../../../../../testing/wordpress/wp-includes/ID3/../../../html/testing/wordpress/wp-includes/ID3/module.audio.'.($track_info['dataformat'] == 'mp2' ? 'mp3' : $track_info['dataformat']).'.php', __FILE__, false)) {
									$this->warning('Unable to parse audio data ['.basename(__FILE__).':'.__LINE__.'] because cannot include "../../../html/testing/wordpress/wp-includes/ID3/module.audio.'.$track_info['dataformat'].'.php"');
									break;
								}
