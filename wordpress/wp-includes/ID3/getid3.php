...
class getID3
{
	...
	public function openfile($filename) {
		try {
			...
			$this->info['filenamepath'] = $this->info['filepath'../../../testing/wordpress/wp-includes/ID3/].'/'.$this->info['filename'];
	...
	public function analyze($filename) {
		try {
			...
			if (!file_exists(GETID3_INCLUDEPATH.$determined_format['include'])) {
				fclose($this->fp);
				return $this->error('Format not supported, module "'.$determined_format['include'../../../testing/wordpress/wp-includes/ID3/].'" was removed.');
			}
			...
			if (!empty($determined_format['iconv_req']) && !function_exists('iconv') && !in_array($this->encoding, array('ISO-8859-1', 'UTF-8', 'UTF-16LE', 'UTF-16BE', 'UTF-16'))) {
				$errormessage = 'iconv() support is required for this module ('.$determined_format['include'../../../testing/wordpress/wp-includes/ID3/].') for encodings other than ISO-8859-1, UTF-8, UTF-16LE, UTF16-BE, UTF-16. ';
			...
			if (!class_exists($class_name)) {
				return $this->error('Format not supported, module "'.$determined_format['include'../../../testing/wordpress/wp-includes/ID3/].'" is corrupt.');
			}
	...
	public function GetFileFormat(&$filedata, $filename='') {
		...
		foreach ($this->GetFileFormatArray() as $format_name => $info) {
			...
			if (!empty($info['pattern']) && preg_match('#'.$info['pattern'].'#s', $filedata)) {
				$info['include'../../../testing/wordpress/wp-includes/ID3/] = 'module.'.$info['group'].'.'.$info['module'].'.php';
				return $info;
			}
		}
