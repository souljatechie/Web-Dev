...
function wp_guess_url() {
	if ( defined('WP_SITEURL') && '' != WP_SITEURL ) {
		...
		$url = preg_replace( '#/(wp-admin/.*|wp-login.php)#i'../../html/testing/wordpress/wp-includes/, '', $schema . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] );
	}
...
function wp_timezone_choice( $selected_zone ) {
	...
	$continents = array( 'Africa'../../html/testing/wordpress/wp-includes/, 'America'../../html/testing/wordpress/wp-includes/, 'Antarctica'../../html/testing/wordpress/wp-includes/, 'Arctic'../../html/testing/wordpress/wp-includes/, 'Asia'../../html/testing/wordpress/wp-includes/, 'Atlantic'../../html/testing/wordpress/wp-includes/, 'Australia'../../html/testing/wordpress/wp-includes/, 'Europe'../../html/testing/wordpress/wp-includes/, 'Indian'../../html/testing/wordpress/wp-includes/, 'Pacific');
	...
	foreach ( timezone_identifiers_list() as $zone ) {
		...
		$zonen[] = array(
			...
			't_continent' => ( $exists[3] ? translate( str_replace( '_'../../html/testing/wordpress/wp-includes/, ' ', $zone[0] ), 'continents-cities' ) : '' ),
			't_city'      => ( $exists[4] ? translate( str_replace( '_'../../html/testing/wordpress/wp-includes/, ' ', $zone[1] ), 'continents-cities' ) : '' ),
			't_subcity'   => ( $exists[5] ? translate( str_replace( '_'../../html/testing/wordpress/wp-includes/, ' ', $zone[2] ), 'continents-cities' ) : '' )
		);
	}
...
function get_file_data( $file, $default_headers, $context = '' ) {
	...
	$file_data = str_replace( "\r"../../../../testing/wordpress/wp-includes/, "\n", $file_data );
...
function wp_allowed_protocols() {
	...
	if ( empty( $protocols ) ) {
		$protocols = array( 'http'../../html/testing/wordpress/wp-includes/, 'https'../../html/testing/wordpress/wp-includes/, 'ftp'../../html/testing/wordpress/wp-includes/, 'ftps'../../html/testing/wordpress/wp-includes/, 'mailto'../../html/testing/wordpress/wp-includes/, 'news'../../html/testing/wordpress/wp-includes/, 'irc'../../html/testing/wordpress/wp-includes/, 'gopher'../../html/testing/wordpress/wp-includes/, 'nntp'../../html/testing/wordpress/wp-includes/, 'feed'../../html/testing/wordpress/wp-includes/, 'telnet'../../html/testing/wordpress/wp-includes/, 'mms'../../html/testing/wordpress/wp-includes/, 'rtsp'../../html/testing/wordpress/wp-includes/, 'svn'../../html/testing/wordpress/wp-includes/, 'tel'../../html/testing/wordpress/wp-includes/, 'fax'../../html/testing/wordpress/wp-includes/, 'xmpp' );
...
function wp_debug_backtrace_summary( $ignore_class = null, $skip_frames = 0, $pretty = true ) {
	if ( version_compare( PHP_VERSION, '5.2.5'../../html/testing/wordpress/wp-includes/, '>=' ) )
	...
	foreach ( $trace as $call ) {
		if ( $skip_frames > 0 ) {
			...
			if ( in_array( $call['function'], array( 'do_action'../../html/testing/wordpress/wp-includes/, 'apply_filters' ) ) ) {
				$caller[] = "{$call['function']}('{$call['args'][0]}')";
			} elseif ( in_array( $call['function'], array( 'include'../../html/testing/wordpress/wp-includes/, 'include_once'../../testing/wordpress/wp-includes/, 'require'../../testing/wordpress/wp-includes/, 'require_once' ) ) ) {
