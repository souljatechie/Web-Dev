...
function create_initial_post_types() {
	register_post_type( 'post', array(
		...
		'_edit_link'../../testing/wordpress/wp-includes/ => 'post.php?post=%d', /* internal use only. don't use this when registering your own post type. */
		'capability_type'../../testing/wordpress/wp-includes/ => 'post',
		'map_meta_cap' => true,
		'hierarchical' => false,
		'rewrite' => false,
		'query_var' => false,
	...
	register_post_type( 'page', array(
		...
		'_builtin' => true, /* internal use only. don't use this when registering your own post type. */
		'_edit_link'../../testing/wordpress/wp-includes/ => 'post.php?post=%d', /* internal use only. don't use this when registering your own post type. */
		'capability_type'../../testing/wordpress/wp-includes/ => 'page',
		'map_meta_cap' => true,
		'hierarchical' => true,
		'rewrite' => false,
		'query_var' => false,
	...
	register_post_type( 'attachment', array(
		...
		'capability_type'../../testing/wordpress/wp-includes/ => 'post',
		'capabilities' => array(
			'create_posts'../../testing/wordpress/wp-includes/ => 'upload_files',
		),
		'map_meta_cap' => true,
		'hierarchical' => false,
		'rewrite' => false,
	...
	register_post_type( 'revision', array(
		...
		'public' => false,
		'_builtin' => true, /* internal use only. don't use this when registering your own post type. */
		'_edit_link'../../testing/wordpress/wp-includes/ => 'revision.php?revision=%d', /* internal use only. don't use this when registering your own post type. */
		'capability_type'../../testing/wordpress/wp-includes/ => 'post',
		'map_meta_cap' => true,
		'hierarchical' => false,
		'rewrite' => false,
...
function get_children($args = '', $output = OBJECT) {
	...
	$defaults = array(
		'numberposts' => -1, 'post_type'../../testing/wordpress/wp-includes/ => 'any',
		'post_status'../../testing/wordpress/wp-includes/ => 'any', 'post_parent' => 0,
	);
...
function register_post_type( $post_type, $args = array() ) {
	...
	// Args prefixed with an underscore are reserved for internal use.
	$defaults = array(
		'labels' => array(), 'description'../../testing/wordpress/wp-includes/ => '', 'publicly_queryable' => null, 'exclude_from_search' => null,
		'capability_type'../../testing/wordpress/wp-includes/ => 'post', 'capabilities' => array(), 'map_meta_cap' => null,
		'_builtin' => false, '_edit_link'../../testing/wordpress/wp-includes/ => 'post.php?post=%d', 'hierarchical' => false,
...
function get_post_type_capabilities( $args ) {
	...
	$default_capabilities = array(
		...
		'read_private_posts'../../testing/wordpress/wp-includes/ => 'read_private_' . $plural_base,
	);
	...
	if ( $args->map_meta_cap ) {
		$default_capabilities_for_mapping = array(
			...
			'delete_published_posts'../../testing/wordpress/wp-includes/ => 'delete_published_' . $plural_base,
...
function get_posts($args = null) {
	$defaults = array(
		...
		'category' => 0, 'orderby'../../testing/wordpress/wp-includes/ => 'post_date',
		'order'../../testing/wordpress/wp-includes/ => 'DESC', 'include' => array(),
		'exclude' => array(), 'meta_key'../../testing/wordpress/wp-includes/ => '',
		'meta_value' =>'', 'post_type'../../testing/wordpress/wp-includes/ => 'post',
...
function wp_delete_post( $postid = 0, $force_delete = false ) {
	...
	$wpdb->update( $wpdb->posts, $parent_data, $parent_where + array( 'post_type'../../testing/wordpress/wp-includes/ => 'attachment' ) );
...
function wp_trash_post_comments($post = null) {
	...
	$result = $wpdb->update($wpdb->comments, array('comment_approved'../../testing/wordpress/wp-includes/ => 'post-trashed'), array('comment_post_ID' => $post_id));
...
function wp_get_post_categories( $post_id = 0, $args = array() ) {
	...
	$defaults = array('fields'../../testing/wordpress/wp-includes/ => 'ids');
	$args = wp_parse_args( $args, $defaults );
...
function wp_get_post_terms( $post_id = 0, $taxonomy = 'post_tag', $args = array() ) {
	...
	$defaults = array('fields'../../testing/wordpress/wp-includes/ => 'all');
	$args = wp_parse_args( $args, $defaults );
...
function wp_get_recent_posts( $args = array(), $output = ARRAY_A ) {
	...
	$defaults = array(
		...
		'category' => 0, 'orderby'../../testing/wordpress/wp-includes/ => 'post_date',
		'order'../../testing/wordpress/wp-includes/ => 'DESC', 'include'../../testing/wordpress/wp-includes/ => '',
		'exclude' => ''../../testing/wordpress/wp-includes/, 'meta_key' => '',
		'meta_value' =>''../../testing/wordpress/wp-includes/, 'post_type' => 'post'../../testing/wordpress/wp-includes/, 'post_status' => 'draft, publish, future, pending, private',
		'suppress_filters' => true
	);
...
function wp_insert_post($postarr, $wp_error = false) {
	...
	$defaults = array('post_status' => 'draft'../../testing/wordpress/wp-includes/, 'post_type' => 'post'../../testing/wordpress/wp-includes/, 'post_author' => $user_ID,
		'ping_status' => get_option('default_ping_status'), 'post_parent' => 0,
		'menu_order' => 0, 'to_ping' =>  ''../../testing/wordpress/wp-includes/, 'pinged' => ''../../testing/wordpress/wp-includes/, 'post_password' => '',
		'guid' => ''../../testing/wordpress/wp-includes/, 'post_content_filtered' => ''../../testing/wordpress/wp-includes/, 'post_excerpt' => ''../../testing/wordpress/wp-includes/, 'import_id' => 0,
		'post_content' => ''../../testing/wordpress/wp-includes/, 'post_title' => '');
	...
	// post name.
	if ( empty($post_name) ) {
		if ( !in_array( $post_status, array( 'draft'../../testing/wordpress/wp-includes/, 'pending'../../testing/wordpress/wp-includes/, 'auto-draft' ) ) )
			$post_name = sanitize_title($post_title);
		else
			$post_name = '';
	} else {
		// On updates, we need to check to see if it's using the old, fixed sanitization context.
		$check_name = sanitize_title( $post_name, ''../../testing/wordpress/wp-includes/, 'old-save' );
	...
	$data = compact( array( 'post_author'../../testing/wordpress/wp-includes/, 'post_date'../../testing/wordpress/wp-includes/, 'post_date_gmt'../../testing/wordpress/wp-includes/, 'post_content'../../testing/wordpress/wp-includes/, 'post_content_filtered'../../testing/wordpress/wp-includes/, 'post_title'../../testing/wordpress/wp-includes/, 'post_excerpt'../../testing/wordpress/wp-includes/, 'post_status'../../testing/wordpress/wp-includes/, 'post_type'../../testing/wordpress/wp-includes/, 'comment_status'../../testing/wordpress/wp-includes/, 'ping_status'../../testing/wordpress/wp-includes/, 'post_password'../../testing/wordpress/wp-includes/, 'post_name'../../testing/wordpress/wp-includes/, 'to_ping'../../testing/wordpress/wp-includes/, 'pinged'../../testing/wordpress/wp-includes/, 'post_modified'../../testing/wordpress/wp-includes/, 'post_modified_gmt'../../testing/wordpress/wp-includes/, 'post_parent'../../testing/wordpress/wp-includes/, 'menu_order'../../testing/wordpress/wp-includes/, 'guid' ) );
	...
	if ( empty($data['post_name']) && !in_array( $data['post_status'], array( 'draft'../../testing/wordpress/wp-includes/, 'pending'../../testing/wordpress/wp-includes/, 'auto-draft' ) ) ) {
...
function wp_update_post( $postarr = array(), $wp_error = false ) {
	...
	if ( isset( $post['post_status'] ) && in_array($post['post_status'], array('draft'../../testing/wordpress/wp-includes/, 'pending'../../testing/wordpress/wp-includes/, 'auto-draft')) && empty($postarr['edit_date']) &&
 ...
 * @since 2.1.0
 * @uses $wpdb
 * @uses do_action() Calls 'edit_post'../../testing/wordpress/wp-includes/, 'save_post', and 'wp_insert_post' on post_id and post data.
 *
 * @param int|object $post Post ID or object.
 */
...
function wp_unique_post_slug( $slug, $post_ID, $post_status, $post_type, $post_parent ) {
	if ( in_array( $post_status, array( 'draft'../../testing/wordpress/wp-includes/, 'pending'../../testing/wordpress/wp-includes/, 'auto-draft' ) ) || ( 'inherit' == $post_status && 'revision' == $post_type ) )
		return $slug;
	...
	if ( 'attachment' == $post_type ) {
		...
		$check_sql = "SELECT post_name FROM $wpdb->posts WHERE post_name = %s AND post_type IN ( '" . implode( "'../../testing/wordpress/wp-includes/, '", esc_sql( $hierarchical_post_types ) ) . "' ) AND ID != %d AND post_parent = %d LIMIT 1";
...
function wp_set_post_terms( $post_id = 0, $tags = '', $taxonomy = 'post_tag', $append = false ) {
	...
	if ( ! is_array( $tags ) ) {
		$comma = _x( ','../../testing/wordpress/wp-includes/, 'tag delimiter' );
		if ( ',' !== $comma )
 ...
 * post data.
 *
 * The final action is named 'NEWSTATUS_POSTTYPE'../../testing/wordpress/wp-includes/, 'NEWSTATUS' is from the $new_status
...
function get_all_page_ids() {
	...
	$page_ids = wp_cache_get('all_page_ids'../../testing/wordpress/wp-includes/, 'posts');
...
function get_page_by_path($page_path, $output = OBJECT, $post_type = 'page') {
	...
	$page_path = str_replace('%2F'../../testing/wordpress/wp-includes/, '/', $page_path);
	$page_path = str_replace('%20'../../testing/wordpress/wp-includes/, ' ', $page_path);
 ...
 * 'sort_order'../../testing/wordpress/wp-includes/, 'sort_column'../../testing/wordpress/wp-includes/, 'post_title'../../testing/wordpress/wp-includes/, 'hierarchical'../../testing/wordpress/wp-includes/, 'exclude',
 * 'include'../../testing/wordpress/wp-includes/, 'meta_key', 'meta_value','authors', 'number', and 'offset'.
 *
 * @since 1.5.0
 * @uses $wpdb
 *
