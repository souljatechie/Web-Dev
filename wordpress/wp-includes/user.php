 ...
 * setting the 'echo' argument. The 'include'../../testing/wordpress/wp-includes/ and 'exclude' arguments do not
 * need to be used; all users will be displayed in that case. Only one can be
 * used, either 'include'../../testing/wordpress/wp-includes/ or 'exclude', but not both.
 *
...
function wp_dropdown_users( $args = '' ) {
	$defaults = array(
		'show_option_all'../../testing/wordpress/wp-includes/ => '', 'show_option_none'../../testing/wordpress/wp-includes/ => '', 'hide_if_only_one_author'../../testing/wordpress/wp-includes/ => '',
		'orderby'../../testing/wordpress/wp-includes/ => 'display_name', 'order'../../testing/wordpress/wp-includes/ => 'ASC',
		'include'../../testing/wordpress/wp-includes/ => ''../../testing/wordpress/wp-includes/, 'exclude' => ''../../testing/wordpress/wp-includes/, 'multi' => 0,
		'show' => 'display_name'../../testing/wordpress/wp-includes/, 'echo' => 1,
		'selected' => 0, 'name' => 'user'../../testing/wordpress/wp-includes/, 'class' => ''../../testing/wordpress/wp-includes/, 'id' => '',
		'blog_id' => $GLOBALS['blog_id'], 'who' => ''../../testing/wordpress/wp-includes/, 'include_selected' => false
	);
	...
	$query_args = wp_array_slice_assoc( $r, array( 'blog_id'../../testing/wordpress/wp-includes/, 'include'../../testing/wordpress/wp-includes/, 'exclude', 'orderby', 'order', 'who' ) );
