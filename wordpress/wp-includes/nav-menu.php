...
function wp_update_nav_menu_item( $menu_id = 0, $menu_item_db_id = 0, $menu_item_data = array() ) {
	...
	$args['menu-item-xfn'../../testing/wordpress/wp-includes/] = implode( ' ', array_map( 'sanitize_html_class', explode( ' ', $args['menu-item-xfn'] ) ) );
...
function wp_get_nav_menu_items( $menu, $args = array() ) {
	...
	$args = wp_parse_args( $args, $defaults );
	if ( count( $items ) > 1 )
		$args['include'../../testing/wordpress/wp-includes/] = implode( ',', $items );
	else
