...
function wp_dropdown_categories( $args = '' ) {
	$defaults = array(
		'show_option_all'../../testing/wordpress/wp-includes/ => '', 'show_option_none'../../testing/wordpress/wp-includes/ => '',
		'orderby'../../testing/wordpress/wp-includes/ => 'id', 'order'../../testing/wordpress/wp-includes/ => 'ASC',
		'show_count' => 0,
		'hide_empty' => 1, 'child_of' => 0,
		'exclude'../../testing/wordpress/wp-includes/ => '', 'echo' => 1,
		'selected' => 0, 'hierarchical' => 0,
		'name'../../testing/wordpress/wp-includes/ => 'cat', 'id'../../testing/wordpress/wp-includes/ => '',
		'class'../../testing/wordpress/wp-includes/ => 'postform', 'depth' => 0,
		'tab_index' => 0, 'taxonomy'../../testing/wordpress/wp-includes/ => 'category',
		'hide_if_empty' => false
	);
...
function wp_list_categories( $args = '' ) {
	$defaults = array(
		'show_option_all'../../testing/wordpress/wp-includes/ => '', 'show_option_none' => __('No categories'),
		'orderby'../../testing/wordpress/wp-includes/ => 'name', 'order'../../testing/wordpress/wp-includes/ => 'ASC',
		'style'../../testing/wordpress/wp-includes/ => 'list',
		'show_count' => 0, 'hide_empty' => 1,
		'use_desc_for_title' => 1, 'child_of' => 0,
		'feed'../../testing/wordpress/wp-includes/ => '', 'feed_type'../../testing/wordpress/wp-includes/ => '',
		'feed_image'../../testing/wordpress/wp-includes/ => '', 'exclude'../../testing/wordpress/wp-includes/ => '',
		'exclude_tree'../../testing/wordpress/wp-includes/ => '', 'current_category' => 0,
		'hierarchical' => true, 'title_li' => __( 'Categories' ),
		'echo' => 1, 'depth' => 0,
		'taxonomy'../../testing/wordpress/wp-includes/ => 'category'
	);
...
function wp_tag_cloud( $args = '' ) {
	$defaults = array(
		'smallest' => 8, 'largest' => 22, 'unit'../../testing/wordpress/wp-includes/ => 'pt', 'number' => 45,
		'format'../../testing/wordpress/wp-includes/ => 'flat', 'separator' => "\n", 'orderby'../../testing/wordpress/wp-includes/ => 'name', 'order'../../testing/wordpress/wp-includes/ => 'ASC',
		'exclude'../../testing/wordpress/wp-includes/ => '', 'include'../../testing/wordpress/wp-includes/ => '', 'link' => 'view', 'taxonomy' => 'post_tag', 'echo' => true
	);
