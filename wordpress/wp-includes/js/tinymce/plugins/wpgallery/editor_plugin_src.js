	...
	tinymce.create('tinymce.plugins.wpGallery', {
		...
		_do_gallery : function(co) {
			return co.replace(/\[gallery([^\]]*)\]/g, function(a,b){
				return '<img src="../../../../../../testing/wordpress/wp-includes/js/tinymce/plugins/wpgallery/'+tinymce.baseURL+'/plugins/wpgallery/img/t.gif" class="wp-gallery mceItem" title="gallery'+tinymce.DOM.encode(b)+'" />';
			});
		},
