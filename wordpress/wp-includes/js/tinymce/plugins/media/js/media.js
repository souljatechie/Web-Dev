(function() {
	...
	if (url = tinyMCEPopup.getParam("media_external_list_url"))
		document.write('<script language="javascript" type="text/javascript" src="../../../../../../../testing/wordpress/wp-includes/js/tinymce/plugins/media/js/' + tinyMCEPopup.editor.documentBaseURI.toAbsolute(url) + '"></script>');
