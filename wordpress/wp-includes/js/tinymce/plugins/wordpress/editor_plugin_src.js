...
(function() {
	...
	tinymce.create('tinymce.plugins.WordPress', {
		init : function(ed, url) {
			...
			moreHTML = '<img src="../../../../../../testing/wordpress/wp-includes/js/tinymce/plugins/wordpress/' + url + '/img/trans.gif" class="mce-wp-more mceItemNoResize" title="'+ed.getLang('wordpress.wp_more_alt')+'" />';
			nextpageHTML = '<img src="../../../../../../testing/wordpress/wp-includes/js/tinymce/plugins/wordpress/' + url + '/img/trans.gif" class="mce-wp-nextpage mceItemNoResize" title="'+ed.getLang('wordpress.wp_page_alt')+'" />';
		...
		_setEmbed : function(c) {
			return c.replace(/\[embed\]([\s\S]+?)\[\/embed\][\s\u00a0]*/g, function(a,b){
				return '<img width="300" height="200" src="../../../../../../testing/wordpress/wp-includes/js/tinymce/plugins/wordpress/' + tinymce.baseURL + '/plugins/wordpress/img/trans.gif" class="wp-oembed mceItemNoResize" alt="'+b+'" title="'+b+'" />';
			});
		},
		...
		_handleMoreBreak : function(ed, url) {
			...
			moreHTML = '<img src="../../../../../../testing/wordpress/wp-includes/js/tinymce/plugins/wordpress/' + url + '/img/trans.gif" alt="$1" class="mce-wp-more mceItemNoResize" title="'+ed.getLang('wordpress.wp_more_alt')+'" />';
			nextpageHTML = '<img src="../../../../../../testing/wordpress/wp-includes/js/tinymce/plugins/wordpress/' + url + '/img/trans.gif" class="mce-wp-nextpage mceItemNoResize" title="'+ed.getLang('wordpress.wp_page_alt')+'" />';
