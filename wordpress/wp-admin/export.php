...
<?php
		...
		wp_dropdown_users( array( 'include'../../testing/wordpress/wp-admin/ => $authors, 'name' => 'post_author', 'multi' => true, 'show_option_all' => __('All') ) );
?>
	</li>
	<li>
...
<?php
		...
		wp_dropdown_users( array( 'include'../../testing/wordpress/wp-admin/ => $authors, 'name' => 'page_author', 'multi' => true, 'show_option_all' => __('All') ) );
?>
	</li>
	<li>
		<label><?php _e( 'Date range:' ); ?></label>
